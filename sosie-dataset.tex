...
\input{intro.tex}
\section{Good sosies}
\input{writestringtofile.tex}
\input{tojson.tex}
\input{decode.tex}
\input{getentry.tex}
\input{setseed.tex}
\input{createtypevariablemap.tex}
\input{capture-tostring.tex}
\input{invoke.tex}
...
\input{rhino-hashcode.tex}
\input{rhino-setlp.tex}
\input{rhino-ensureIndex.tex}
\input{rhino-setvalidattributes.tex}
\input{rhino-stopmethod.tex}
\input{rhino-convertarg.tex}
